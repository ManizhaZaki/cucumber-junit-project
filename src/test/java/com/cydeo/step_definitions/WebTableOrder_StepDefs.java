...
public class WebTableOrder_StepDefs {
    ...
    public void user_enters_quantity(Integer int1) {
        ...
        //first we need to clear that input and we will send keys later
    ...
    public void user_should_see_in_first_row_of_the_web_table(String expectedCustomerNmae) {
        String actualCustomerName = viewAllOrdersPage.newCustomerCell.getText();
        Assert.assertEquals(expectedCustomerNmae,actualCustomerName);
    }
}
